...
import com.example.coronatesttracker.databinding.FragmentWelcomeBinding
...
class welcomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.btCreateNewReport.setOnClickListener { view ->
            view.findNavController().navigate(R.id.action_welcomeFragment_to_fragment_inputfragment)
        }
